...
const styles = {
  ...
  /* Mobile top bar */
  mobileTopBar:{ display:'none', alignItems:'center', justifyContent:'space-between', padding:'0 1rem', height:56, background:'var(--bg-secondary)', borderBottom:'1px solid var(--border)', position:'fixed', top:0, left:0, right:0, zIndex:150,
  ...
  /* Main */
  main:        { flex:1, padding:'2rem', overflowY:'auto', maxWidth:'100%', paddingBottom:'80px' },
